Public Class DATEandTIMEmainmenuIMS
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If carwash_bool(0) = True Then
            ...
            lbl_c1_countup.Text = (Date.Now() - Date.Parse(mainprocess.carwash_datalist(0, 0))).ToString
        ...
        If carwash_bool(1) = True Then
            ...
            lbl_c2_countup.Text = (Date.Now() - Date.Parse(mainprocess.carwash_datalist(1, 0))).ToString
        ...
        If carwash_bool(2) = True Then
            ...
            lbl_c3_countup.Text = (Date.Now() - Date.Parse(mainprocess.carwash_datalist(2, 0))).ToString
        ...
        If carwash_bool(3) = True Then
            ...
            lbl_c4_countup.Text = (Date.Now() - Date.Parse(mainprocess.carwash_datalist(3, 0))).ToString
        ...
        If carwash_bool(4) = True Then
            ...
            lbl_c5_countup.Text = (Date.Now() - Date.Parse(mainprocess.carwash_datalist(4, 0))).ToString
        ...
        If carwash_bool(5) = True Then
            ...
            lbl_c6_countup.Text = (Date.Now() - Date.Parse(mainprocess.carwash_datalist(5, 0))).ToString
    ...
    Private Sub DateToday_TextChanged(sender As Object, e As EventArgs) Handles DateToday.TextChanged
